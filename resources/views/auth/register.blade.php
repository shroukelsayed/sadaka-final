...
<head>
    ...
    var Applet = new function() {
        var basePath = '/signup';
        var phpVars = {"eventLogReferrer":"desktop_site","isVpn":false,"eventLoggingData":{"referrer_url":null,"page_url":"\/signup\/","context":"signup","campaign":"","recognized":"1","affiliate":false,"offer":false,"site":"desktop","visitor_id":"197.134.255.239.1464129120987619","device":"desktop","elance_reg":false},"flowToEventLogName":{"client_direct":"registration_client_signup","client_post_job":"registration_client_post","client_post_job_choice":"registration_client_post_choice","client_post_job_fields":"registration_client_post_fields","client_contact_freelancer":"registration_client_contact","client_view_profile":"registration_client_profile","client_more_freelancers":"registration_client_search","client_oauth_provider":"registration_client_oauth_provider","client_elance_invitation":"registration_client_elance","client_elance_invitation_post_job":"registration_client_elance_replication_post","client_elance_direct":"registration_client_elance_direct","client_elance_post_job":"registration_client_elance_post","client_zendesk":"registration_client_zendesk","client_direct_iframe":"registration_client_direct_iframe","client_direct_marketing_iframe":"registration_client_direct_marketing_iframe","client_contact_freelancer_iframe":"registration_client_contact_iframe","client_post_job_iframe":"registration_client_post_iframe","freelancer_direct":"registration_freelancer","freelancer_join_group":"registration_freelancer_join_group","freelancer_apply_job":"registration_freelancer_apply_job","freelancer_byoc":"registration_freelancer_byoc","freelancer_oauth_provider":"registration_freelancer_oauth_provider","freelancer_elance_invitation":"registration_freelancer_elance","freelancer_elance_direct":"registration_freelancer_elance_direct","freelancer_elance_ptc":"registration_freelancer_elance_ptc","colleague_direct":"registration_colleague_direct","colleague_invite_to_team":"registration_colleague_itt","colleague_invite_to_team_d":"registration_colleague_itt_dash","colleague_ptc":"registration_colleague_ptc","agency_elance_invitation":"registration_agency_elance","agency_freelancer_elance":"registration_agency_freelancer_elance","client_visitor_api":"registration_client_visitor_api"},"csrfTokenCookieName":"XSRF-TOKEN","csrfTokenHeaderName":"X-Odesk-Csrf-Token","runtime_id":"0309555745728638de4","clientStatsDMetrics":true,"smfAjax":false};
        var angularCache = [];
        var assetsVersion = "3515dab";
        ...
        var visitorId = null;
                visitorId = "197.134.255.239.1464129120987619";
        ...
        var visitorApiKey = null;
                    visitorApiKey = "8c770eefc9397250947aeb7590b954ab";
...
<body data-ng-app="signUpApp" class="  skinny-layout user-type-page ">
        ...
        <div data-o-smf data-o-smf-location="very_top"></div>
                    <header class="header-navbar-wrapper header-navbar-skinny" role="banner" data-ng-controller="headerController">
    ...
    <div class="container">
        ...
        <div class="nav navbar-nav navbar-right">
            <p class="navbar-text text-right">
                                        <span>Already have an Sadaqa account?</span>
            <br/>
            <a
               href="/login"
               data-eo-halt="trackingService.clickLogin()" target="_self">
                Log In
            </a>
                        </p>
        </div>
...
<!-- Interstitial SMF message -->
    <div class="container user-type-page" ng-controller="userTypePageController">
        <div class="row m-lg-top m-xlg-bottom">
            ...
            <div class="col-md-12 text-center">
                <div class="col-md-2">
                    ...
                    <a class="btn btn-primary text-capitalize m-0" href="/user_infos/create">Donator</a>
                </div>
                ...
                <div class="col-md-2">
                    ...
                    <a class="btn btn-primary text-capitalize m-0" href="/user_infos/create">Benefactor</a>
                </div>
                <div class="col-md-2 o-or-divider">OR</div>
                <div class="col-md-2">
                    <div class="text-muted">
        ...
        <footer class="footer-navbar-wrapper footer-skinny" role="contentinfo" data-ng-controller="footerController">
        <div class="container">
    <div class="row">
        <div class="col-md-12 text-center">
            <p class="copyright">
            ...
            <br />
            <a href="/info/terms/cookie-policy/" target="_self">Cookie Policy</a>
        </div>
    </div>
</div>
    </footer>
