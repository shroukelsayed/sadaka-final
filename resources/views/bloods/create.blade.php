        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('bloods.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <textarea required class="form-control" id="name-field" rows="3" name="name">{{ old("name") }}</textarea>
                       @if($errors->has("name"))
                    ...
                    <textarea required class="form-control" id="address-field" rows="3" name="address">{{ old("address") }}</textarea>
                    ...
                    <div class="form-group">
                      ...
                      <select required name="governorate_id" id="governorate_id_field">
                    ...
                    <div class="form-group">
                      ...
                      <select required name="city_id" id="city_id_field">
                ...
                <div class="form-group @if($errors->has('bloodtype')) has-error @endif">
                    ...
                    <div class="form-group">
                      <label for="g_id_field">Governorate Name </label>
                      <select name="g_id" id="g_id_field">
                          @foreach ($governorates as $key => $value)
                              <option value="{{ $key+1 }}">{{ $value['name'] }}</option>
                          @endforeach
                      </select>
                    ...
                    <div class="form-group">
                      <label for="c_id_field">City Name </label>
                      <select name="c_id" id="c_id_field">
                          @foreach ($cities as $key => $value)
                              <option value="{{ $key+1 }}">{{ $value['name'] }}</option>
                          @endforeach
                      </select>
                    ...
                    <div class="form-group @if($errors->has('address')) has-error @endif">
                       <label for="address-field">Address</label>
                    <textarea class="form-control" id="address-hos" rows="3" name="address">{{ old("address") }}</textarea>
                       @if($errors->has("address"))
                        <span class="help-block">{{ $errors->first("address") }}</span>
                       @endif
                    </div>
