        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('bloods.update', $blood->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <input required type="text" class="form-control" id="name-field" rows="3" name="name" value="{{ $blood->person->personInfo->name }}"></input type="text">
                       @if($errors->has("name"))
                    ...
                    <input required type="text" class="form-control" id="address-field" rows="3" name="address" value="{{ $blood->person->personInfo->address }}"></input type="text">
                    ...
                    <input required type="text" id="birthdate-field" name="birthdate" class="form-control" value="{{ $blood->person->personInfo->birthdate }}"/>
                 ...
                 <div class="form-group @if($errors->has('gender')) has-error @endif">
                    ...
                    <input required type="text" id="gender-field" name="gender" class="form-control" value="{{ $blood->person->personInfo->gender }}"/>
                    ...
                    <input required type="text" id="maritalstatus-field" name="maritalstatus" class="form-control" value="{{ $blood->person->personInfo->maritalstatus }}"/>
                    ...
                    <input required type="text" id="phone-field" name="phone" class="form-control" value="{{ $blood->person->personInfo->phone }}"/>
                       @if($errors->has("phone"))
                ...
                <div class="form-group @if($errors->has('publishat')) has-error @endif">
                    ...
                    <input required type="text" id="publishat-field" name="publishat" class="form-control" value="{{ $blood->person->publishat }}" disabled/>
                ...
                <div class="form-group @if($errors->has('bloodtype')) has-error @endif">
                    ...
                    <input required type="text" id="bloodtype-field" name="bloodtype" class="form-control" value="{{ $blood->bloodtype }}"/>
