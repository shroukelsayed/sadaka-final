...
<div class="page-header">
    <div class="btn-group pull-right" role="group" aria-label="...">
        <a class="btn btn-primary btn-group" role="group" href="{{ route('bloods.edit', $blood->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
    </div>
                  ...
                  <ul class="nav nav-stacked">
                    ...
                    <li><a>
                        <div class="row">
                            ...
                            <div class="col-md-9"><h7 style="margin-left: 40px;" class="form-control-static">{{$blood->governorate->name}}, {{$blood->city->name}}, {{$blood->address}}</h7></div>
                         </div>
                    </a></li>
                    <li><a>
                        <div class="row">
