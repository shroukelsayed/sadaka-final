            ...
            <form action="{{ route('charities.store') }}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                 ...
                 <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <input type="password" id="cpassword" name="password" class="form-control" value="{{ old("password") }}" required/>
                       @if($errors->has("password"))
                        <span class="help-block">{{ $errors->first("password") }}</span>
                       @endif
                    </div>
                   ...
                   <div class="form-group @if($errors->has('phone')) has-error @endif">
                    ...
                    <div class="form-group @if($errors->has('image1')) has-error @endif">
                      ...
                      <input type="file" id="image1-field" name="image1" class="form-control" value="{{ old("image1") }}"/>
