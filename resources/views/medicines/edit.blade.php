        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('medicines.update', $medicine->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <textarea class="form-control" id="name-field" rows="3" name="name">{{ $medicine->person->personInfo->name }}</textarea>
                       @if($errors->has("name"))
                    ...
                    <textarea class="form-control" id="address-field" rows="3" name="address">{{ $medicine->person->personInfo->address }}</textarea>
                    ...
                    <input type="text" id="birthdate-field" name="birthdate" class="form-control" value="{{ $medicine->person->personInfo->birthdate }}"/>
                 ...
                 <div class="form-group @if($errors->has('gender')) has-error @endif">
                    ...
                    <input type="text" id="gender-field" name="gender" class="form-control" value="{{ $medicine->person->personInfo->gender }}"/>
                    ...
                    <input type="text" id="maritalstatus-field" name="maritalstatus" class="form-control" value="{{ $medicine->person->personInfo->maritalstatus }}"/>
                    ...
                    <input type="text" id="phone-field" name="phone" class="form-control" value="{{ $medicine->person->personInfo->phone }}"/>
                       @if($errors->has("phone"))
                ...
                <div class="form-group @if($errors->has('publishat')) has-error @endif">
                    ...
                    <input type="text" id="publishat-field" name="publishat" class="form-control" value="{{ $medicine->person->publishat }}" disabled/>
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <input type="text" id="amount-field" name="amount" class="form-control" value="{{ $medicine->amount }}"/>
