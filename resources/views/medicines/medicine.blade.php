                    ...
                    <div class="cause">
                        ...
                        <div class="progress cause-progress">
                            ...
                            <h4 class="cause-title" style='text-transform:uppercase'>
                                            ...
                                            <a class="is-active" href="{{ route('medicines.show',$one->id) }}"><h1>{{$one->person->personInfo->name}}</h1></a></h4>              
                            ...
                            <div class="cause-details" id="mycase">
                                ...
                                <label>NUMBER OF PACKETS: </label><span>{{ $one->amount }}</span><br/>
                                 <label>Medicine Name: </label><span> {{  $one->amount  }}</span><br/>
                        ...
                        <div class="form-group col-md-12 ">
                            @if($medicines->count())
                                @foreach($medicines as $one)
                                    ...
                                    ?>
                                @endforeach
                                    <input type="text" class="form-control" name="amount"  id="amount" placeholder="NUMBER OF PACKETS OR AMOUNT OF MONEY:-">
                            @endif    
                        </div>
                    </div>
