                  ...
                  <ul class="nav nav-stacked">
                    ...
                    <li><a>
                        <div class="row">
                            ...
                            <div class="col-md-9"><h7 style="margin-left: 40px;" class="form-control-static">{{$medicine->name}}</h7></div>
                        </div>
                    </a></li>
                    <li><a>
                        <div class="row">
                            ...
                            <div class="col-md-9"><h7 style="margin-left: 40px;" class="form-control-static">{{$medicine->amount}}</h7></div>
                        </div>
                    </a></li>
                    <li><a>
                        <div class="row">
                            ...
                            <div class="col-md-9"><h7 style="margin-left: 40px;" class="form-control-static">{{$medicine->person->intervalType->type}}</h7></div>
                        </div>
                    </a></li>
                    <li><a>
                        <div class="row">
                    ...
                    <li><a>
                        <div class="row">
                            ...
                            <div class="col-md-9"><h7 style="margin-left: 40px;" class="form-control-static">{{$medicine->person->personInfo->phone}}</h7></div>
                        </div>
                    </a></li>
                    <li><a>
                        <div class="row">
                            ...
                            <div class="col-md-9"><h7 style="margin-left: 40px;" class="form-control-static">{{$medicine->person->personInfo->governorate->name}}, {{$medicine->person->personInfo->city->name}}, {{$medicine->person->personInfo->address}}</h7></div>
                        </div>
                    </a></li>
