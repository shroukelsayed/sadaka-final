            ...
            <form action="{{ route('others.update', $other->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                 ...
                 <div class="form-group @if($errors->has('gender')) has-error @endif">
                    ...
                    <input required type="text" id="gender-field" name="gender" class="form-control" value="{{ $other->person->personInfo->gender }}"/>
                    ...
                    <input required type="text" id="maritalstatus-field" name="maritalstatus" class="form-control" value="{{ $other->person->personInfo->maritalstatus }}"/>
