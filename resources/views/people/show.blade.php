          ...
          <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header" style="background-color: #EDB6B6;">
              <div class="pull-right">
                    <a id="apro" class="btn btn-primary" href="{{ route('person_infos.edit', $person_info->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
              </div>
              ...
              <ul class="nav nav-stacked">
                ...
                <li><a>
                    <div class="row">
                        ...
                        <div class="col-md-9"><h7 style="margin-left: 40px;" class="form-control-static">{{$person_info->nationalid}}</h7></div>
                    </div>
                </a></li>
                <li><a>
                    <div class="row">
                ...
                <div class="col-md-12">
                     <!-- Widget: user widget style 1 -->
                      <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header" style="background-color: #EDB6B6;">
                          <div class="pull-right">
                            <a id="apro" class="btn btn-primary" href="{{ route('bloods.edit', $p->blood->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                        </div>
                ...
                <div class="col-md-12">
                     <!-- Widget: user widget style 1 -->
                      <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header" style="background-color: #EDB6B6;">
                          <div class="pull-right">
                            <a id="apro" class="btn btn-primary" href="{{ route('money.edit', $p->money->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                        </div>
                ...
                <div class="col-md-12">
                     <!-- Widget: user widget style 1 -->
                      <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header" style="background-color: #EDB6B6;">
                          <div class="pull-right">
                            <a id="apro" class="btn btn-primary" href="{{ route('medicines.edit', $p->medicine->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                        </div>
                ...
                <div class="col-md-12">
                     <!-- Widget: user widget style 1 -->
                      <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header" style="background-color: #EDB6B6;">
                          <div class="pull-right">
                            <a id="apro" class="btn btn-primary" href="{{ route('others.edit', $p->other->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                        </div>
