...
<div class="page-header">
        <h1>UserTypes / Show #{{$user_type->id}}</h1>
        <form action="{{ route('user_types.destroy', $user_type->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
            ...
            <div class="btn-group pull-right" role="group" aria-label="...">
                <a class="btn btn-warning btn-group" role="group" href="{{ route('user_types.edit', $user_type->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
        ...
        <div class="col-md-12">
            ...
            <form action="#">
                ...
                <div class="form-group">
                     ...
                     <p class="form-control-static">{{$user_type->type}}</p>
                </div>
            </form>
