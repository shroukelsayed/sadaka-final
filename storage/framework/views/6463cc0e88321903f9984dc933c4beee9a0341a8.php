                ...
                <div id="navbar" class="navbar-collapse collapse pull-right">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="has-child"><a href="#">CASES</a>
                      ...
                      <ul class="submenu">
                         <li class="submenu-item"><a href="causes.html">Cases list </a></li>
                    ...
                    <li><a href="gallery.html">COMPAIGNS</a></li>
    ...
    <div class="section-home our-causes animate-onscroll fadeIn">
        ...
        <div class="container">
            ...
            <h2 class="title-style-1">Our Cases <span class="title-under"></span></h2>
               <?php foreach($people as $person_info): ?>
               <?php foreach($person_info->people as $p): ?>
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="cause">
                        ...
                        <div class="cause-details">
                            <?php echo e($person_info->name); ?></br>
                            <?php echo e($person_info->address); ?></br>
                            <?php echo e($person_info->maritalstatus); ?></br>
                            <?php echo e($p->donationType->type); ?></br>                               </br>
                            <?php echo e($p->->type); ?></br>  
                        </div>
