...
<?php $__env->startSection('header'); ?>
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> People / Edit #<?php echo e($person->id); ?></h1>
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('people.update', $person->id)); ?>" method="POST">
              ...
              <div class="form-group <?php if($errors->has('name')): ?> has-error <?php endif; ?>">
                    ...
                    <textarea class="form-control" id="address-field" rows="3" name="address"><?php echo e($person->personInfo->address); ?></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <select name="governorate_id" id="governorate_id_field">
                          <?php foreach($governorates as $key => $value): ?>
                              <option value="<?php echo e($key+1); ?>"><?php echo e($person->personInfo->governorate->name); ?></option>
                          <?php endforeach; ?>
                      </select>
                    </div>
                    <div class="form-group">
                      ...
                      <select name="city_id" id="city_id_field">
                          <?php foreach($cities as $key => $value): ?>
                              <option value="<?php echo e($key+1); ?>"><?php echo e($person->personInfo->city->name); ?></option>
                          <?php endforeach; ?>
                      </select>
                    ...
                    <input type="text" id="gender-field" name="gender" class="form-control" value="<?php echo e($person->personInfo->gender); ?>"/>
                    ...
                    <input type="text" id="maritalstatus-field" name="maritalstatus" class="form-control" value="<?php echo e($person->personInfo->maritalstatus); ?>"/>
                    ...
                    <input type="text" id="phone-field" name="phone" class="form-control" value="<?php echo e($person->personInfo->phone); ?>"/>
                ...
                <div class="form-group <?php if($errors->has('publishat')): ?> has-error <?php endif; ?>">
                    ...
                    <input type="text" id="publishat-field" name="publishat" class="form-control" value="<?php echo e($person->publishat); ?>" disabled/>
                ...
                <div class="form-group">
                      ...
                      <select name="donation_type_id" id="donation_type_id_field" disabled>
                          <?php foreach($donate_types as $key => $value): ?>
                              ...
                              <?php echo e($person->donationType->type); ?></option>
                          <?php endforeach; ?>
                      </select>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select name="interval_type_id" id="interval_type_id_field" disabled>
                          <?php foreach($interval_types as $key => $value): ?>
                              <option value="<?php echo e($key+1); ?>"><?php echo e($person->intervalType->type); ?></option>
                          <?php endforeach; ?>
                      </select>
                    </div>
